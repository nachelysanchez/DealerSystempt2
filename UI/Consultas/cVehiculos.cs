...
namespace DealerSystempt2.UI.Consultas
{
    ...
    public partial class cVehiculos : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "EXEC sp_ConsultarVehiculos " + (filtrocmb.SelectedIndex + 1) + ", " + criterio;
            ...
            {
                ConsultaDTG.Rows.Add(dr["VehiculoId"].ToString(), dr["Modelo"].ToString(), dr["Precio"].ToString(), dr["Anio"].ToString(), dr["Existencia"].ToString());
            }
        }
    }
}
