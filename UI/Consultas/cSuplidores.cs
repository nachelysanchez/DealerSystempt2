...
namespace DealerSystempt2.UI.Consultas
{
    public partial class cSuplidores : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "EXEC sp_ConsultarSuplidores " + (filtrocmb.SelectedIndex + 1) + ", " + criterio;
            ...
            {
                ConsultaDTG.Rows.Add(dr["SuplidorId"].ToString(), dr["Nombre"].ToString(), dr["Empresa"].ToString(), dr["Telefono"].ToString(), dr["Correo"].ToString());
            }
        }
    }
}
